...
@section('seo')
    ...
    <title>{{ $website->name }} | Berita</title>
                            ...
                            <article class="blog">
                                <figure>
                                    <a href="{{ route('news-show', $item->slug) }}"><img
                                            src="{{ Storage::url('images/news/' . $item->image) }}" alt="">
                                ...
                                <div class="post_info">
                                    ...
                                    <h2><a
                                            href="{{ route('news-show', $item->slug) }}">{{ Str::limit($item->title, 100, '...') }}</a>
                                    </h2>
                                    <p>{{ Str::limit(strip_tags($item->content), 200, '...') }}</p>
                                    <ul>
                                        <li>
                                            <div class="thumb"><img
                                                    src="@if ($item->user->photo) {{ Storage::url('images/user/' . $item->user->photo) }} @else https://ui-avatars.com/api/?background=000C32&color=fff&name={{ $item->user->name }} @endif"
                                                    alt=""></div>
                                            {{ $item->user->name }}
                                        </li>
