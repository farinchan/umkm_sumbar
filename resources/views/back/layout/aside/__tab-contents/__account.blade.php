    ...
    <div class="mb-12">
        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
            ...
            <div class="flex-grow-1 me-2">
                <a href="?page=widgets/lists" class="fw-bold text-gray-800 text-hover-primary fs-6">My Profile</a>
        ...
        {{-- <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                ...
                <!--begin::Title-->
                <div class="flex-grow-1 me-2">
                    <a href="?page=widgets/lists" class="fw-bold text-gray-800 text-hover-primary fs-6">Humbert Bresnen</a>
