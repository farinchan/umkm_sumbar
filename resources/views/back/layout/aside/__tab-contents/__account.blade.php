    ...
    <div class="mb-12">
        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
            ...
            <div class="flex-grow-1 me-2">
                <a href="{{ route("account.profile") }}" class="fw-bold text-gray-800 text-hover-primary fs-6">My Profile</a>
        ...
        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                ...
                <!--begin::Title-->
                <div class="flex-grow-1 me-2">
                    <a href="?page=widgets/lists" class="fw-bold text-gray-800 text-hover-primary fs-6" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">Keranjang Belanja</a>
                    <span class="text-muted fw-semibold d-block">Total (0) Produk</span>
                </div>
                <!--end::Title-->
                <!--begin::Lable-->
