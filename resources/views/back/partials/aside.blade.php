                                ...
                                <div class="m-0">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <!--begin::Title-->
                                                <h5 class="custom-list-title fw-bold text-gray-800 mb-1">KC
                                                    Account CRM</h5>
                                                <!--end::Title-->
                                                <!--begin::Link-->
                                        ...
                                        <a href="../../demo7/dist/pages/projects/project.html"
                                            ...
                                            <div class="symbol symbol-40px me-5">
                                                <span class="symbol-label">
                                                    <img src="assets/media/svg/brand-logos/infography.svg"
                                                        class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                            ...
                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0"
                                ...
                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                    ...
                                    <div class="menu-item">
                                        <div class="menu-content pt-8 pb-0">
                                            <span
                                                class="menu-section text-muted text-uppercase fs-8 ls-1">Pengaturan</span>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link"
