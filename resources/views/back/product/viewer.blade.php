                            ...
                            <tbody class="fs-6">
                                @foreach ($product_viewer as $viewer)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="@if (request()->is('back/shop/product/viewer')) {{ route('shop.product.detail', $viewer->product->id) }}
                                            @else
                                                {{ route('shop.product.detail', $viewer->product->id) }} @endif"
                                                class="fs-6 text-gray-800 text-hover-primary">{{ $viewer->product->name }}</a>

                                        </td>
                                        <td>
                                            @if ($viewer->latitude && $viewer->longitude)
                                                <a target="_blank"
                                                    href="https://www.google.com/maps/search/{{ $viewer->latitude }},{{ $viewer->longitude }}"
