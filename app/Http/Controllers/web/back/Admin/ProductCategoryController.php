...
class ProductCategoryController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('back.product_category.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            Alert::error('Failed', $validator->errors()->all());
            return redirect()->route('admin.product.category.edit', $id)->with('error', 'Failed to update Product Category')->withInput()->withErrors($validator);
        }
        ...
        Alert::success('Success', 'Kategori Produk berhasil diubah');
    ...
    {
        $productCategory = ProductCategory::find($id);
        Storage::delete('images/product_category/' . $productCategory->image);
